...
import '../parsers/bambu_lab_rfid_parser.dart';
...
class RfidData {
  ...
  /// Uses the enhanced Bambu Lab RFID parser for complete tag parsing
  factory RfidData.fromBlockDump(Map<String, String> blocks) {
    return BambuLabRfidParser.parseFromBlockDump(blocks);
  }

  /// Create from raw RFID bytes (1024 bytes from MIFARE 1K dump)
  factory RfidData.fromBytes(List<int> data) {
    final bytes = data is Uint8List ? data : Uint8List.fromList(data);
    return BambuLabRfidParser.parseFromBytes(bytes);
  }

  /// Create from Flipper Zero NFC dump format
  factory RfidData.fromFlipperDump(String flipperData) {
    return BambuLabRfidParser.parseFromFlipperDump(flipperData);
  }
